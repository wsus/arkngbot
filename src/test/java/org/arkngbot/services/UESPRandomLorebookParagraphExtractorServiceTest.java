...
public class UESPRandomLorebookParagraphExtractorServiceTest {
    ...
    private static final String FOURTH_PARAGRAPH = "fourthParagraph";
    ...
    public void shouldReturnAParagraph() throws Exception {
        ...
        assertThat(paragraph, anyOf(is(FIRST_PARAGRAPH), is(SECOND_PARAGRAPH), is(THIRD_PARAGRAPH),is(FOURTH_PARAGRAPH)));
    }
